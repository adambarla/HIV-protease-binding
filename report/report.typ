...
The ligand with the lowest binding affinity score was named `fda_553` and it can be seen in @best_ligand.
...
caption: [Ligand with name `fda_553` which reached the lowest binding affinity score of $-11.4$ kcal/mol out of $2116$ ligands tested],
) <best_ligand>

= MD

I added hydrogens to the 